...
<!-- PHP HERE FOR CUSTOMER myorders -->
  ...
  <?php
            ...
            if (isset($_COOKIE['type']) && $_COOKIE['type'] == 'admin') {
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    echo '<tr><th><a href="customers.php?status=pending">Pending (' . $pendingCount . ')</a></th><th><a href="customers.php?status=accepted">Accepted (' . $acceptedCount . ')</a></th><th><a href="customers.php?status=completed">Completed (' . $completedCount . ')</a></th><th><a href="customers.php?status=return/refund">Return/Refund (' . $returnRefundCount . ')</a></th></tr>';
