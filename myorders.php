...
<body>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center;">
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo '<tr><th><a href="myorders.php?status=pending">Pending (' . $pendingCount . ')</a></th>
                      <th><a href="myorders.php?status=accepted">Accepted (' . $acceptedCount . ')</a></th>
                      <th><a href="myorders.php?status=completed">Completed (' . $completedCount . ')</a></th>
                      <th><a href="myorders.php?status=return/refund">Return/Refund (' . $returnRefundCount . ')</a></th></tr>';
